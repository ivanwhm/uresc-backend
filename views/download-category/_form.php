...
<div class="download-category-form">
    ...
    <?= Html::tag('span', '<i class="fa fa-fw fa-question"></i> Informe o nome da categoria de download.', ['id' => 'hbName', 'class' => 'help-block']) ?>

    <?= $form->field($model, 'status')->dropDownList(DownloadCategory::$statusData, ['prompt' => '---', 'aria-describedby' => 'hbStatus']) ?>
    <?= Html::tag('span', '<i class="fa fa-fw fa-question"></i> Informe se a categoria de download está ativa ou inativa.', ['id' => 'hbStatus', 'class' => 'help-block']) ?>
