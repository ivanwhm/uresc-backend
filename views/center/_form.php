...
<div class="center-form">
    ...
    <?= Html::tag('span', Icon::show('info-circle') . Yii::t('center', 'Enter the name of the spiritist center.'), ['id' => 'hbName', 'class' => 'help-block']) ?>

    <?= $form->field($model, 'address')->textInput(['maxlength' => true, 'aria-describedby' => 'hbAddress']) ?>
    <?= Html::tag('span', Icon::show('info-circle') . Yii::t('center', 'Enter the address of the spiritist center.'), ['id' => 'hbAddress', 'class' => 'help-block']) ?>

    <?= $form->field($model, 'neighborhood')->textInput(['maxlength' => true, 'aria-describedby' => 'hbNeighborhood']) ?>
    <?= Html::tag('span', Icon::show('info-circle') . Yii::t('center', 'Enter the neighborhood of the spiritist center.'), ['id' => 'hbNeighborhood', 'class' => 'help-block']) ?>

    <?= $form->field($model, 'city')->textInput(['maxlength' => true, 'aria-describedby' => 'hbCity']) ?>
    <?= Html::tag('span', Icon::show('info-circle') . Yii::t('center', 'Enter the city of the spiritist center.'), ['id' => 'hbCity', 'class' => 'help-block']) ?>

    <?= $form->field($model, 'state')->textInput(['maxlength' => true, 'aria-describedby' => 'hbState']) ?>
    <?= Html::tag('span', Icon::show('info-circle') . Yii::t('center', 'Enter the state of the spiritist center.'), ['id' => 'hbState', 'class' => 'help-block']) ?>

    <?= $form->field($model, 'phone')->widget(MaskedInput::className(), ['mask' => $mask]) ?>
    <?= Html::tag('span', Icon::show('info-circle') . Yii::t('center', 'Enter the phone of the spiritist center.'), ['id' => 'hbPhone', 'class' => 'help-block']) ?>

    <?= $form->field($model, 'email')->textInput(['maxlength' => true, 'aria-describedby' => 'hbEmail']) ?>
    <?= Html::tag('span', Icon::show('info-circle') . Yii::t('center', 'Enter the e-mail of the spiritist center.'), ['id' => 'hbEmail', 'class' => 'help-block']) ?>
